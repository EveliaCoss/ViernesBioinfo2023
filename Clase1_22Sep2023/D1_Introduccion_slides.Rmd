...
Todo lo anterior esta bien, pero ahora como hago que la computadora ejecute el algoritmo.
...
## Entendiendo el funcionamiento del codigo
...
> Volver a correr el codigo y verificar la salida.
...
- *Informacion*: El siguiente programa realiza la suma de dos numeros enteros a partir de la entrada del usuario y posteriormente la imprime en pantalla.

- *Input*: Solo numeros enteros (sin decimales).

- ¿Cómo se utiliza y para qué sirve?

---

## Ejercicio

1) Cual es el error del siguiente codigo? .spoiler[La variable no ha sido declarada]
...
3) Obtener perimetro de un rectangulo que mide 7 cm de ancho (altura, h) y 10 cm de largo (base, b). Genera su diagrama de flujo e imprime su resultado.
